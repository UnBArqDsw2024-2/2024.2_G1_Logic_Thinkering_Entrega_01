...
| **Noções**        | <ul> <li>Uma receita é uma instrução de quais materiais são necessários para fabricar um certo item, e como eles devem ser arranjados em uma malha (para o caso de crafting tables)</li></ul>                                                                                                                                                                                                                                                                                                                                                                                                |
| **Impactos**      | <ul><li>Jogadores que desejam fabricar algum item devem coletar os materiais específicos relacionados àquela receita e organizá-los da forma correta na malha de crafting (no caso do minecraft vanilla), para então conseguirem seu item</li><li>Receitas não estão restritas à crafting tables, vários itens podem ser cozinhados em uma fornalha, por exemplo, para produzir novos itens</li><li>Mods no minecraft podem adicionar suas própias receitas para fabricar os materiais do mod, podendo incluir fluídos, magia, engergia elétrica, interação com mobs, entre outros</li></ul> |
...
|**Classificação**| Objeto |
|**Sinônimos** | <ul></ul>|
|**Noções** | <ul> <li>Abreviação de "mobile entity"(entidade móvel), representa todas as entidades dirigidas por IA no minecraft</li></ul>|
|**Impactos** | <ul><li>Criaturas amigáveis e inimigas são mobs no minecraft</li><li>Mobs podem ser atacods e feridos e tem alguma forma de movimento voluntário</li><li>Mobs do minecraft geralmente tem IA com comportamento único, e podem derrubar itens bons ou ruins ao serem mortos</li></ul> |
---
